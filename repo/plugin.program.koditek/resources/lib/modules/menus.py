...
def main_menu():
    ...
    add_dir(COLOR1(f'[B]Welcome to[/B] {addon_name}'), '', '', addon_icon, addon_fanart, COLOR1(f'{addon_name}'), isFolder=False)
...
def restore_gui_skin():
    add_dir(COLOR1('[B]Restore GUI/Skin Settings[/B]'), '', '', addon_icon, addon_fanart, COLOR1('Restore GUI/Skin Settings Menu'), isFolder=False)
